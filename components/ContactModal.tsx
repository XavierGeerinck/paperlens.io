...
import { X, Mail, Github, Twitter, Linkedin, Send, Copy, Check, Globe } from 'lucide-react';
...
const ContactModal: React.FC = () => {
  ...
  const handleCopyEmail = () => {
    navigator.clipboard.writeText('research@example.com');
    setCopied(true);
  ...
  const socialLinks = [
    {
      ...
      url: 'https://www.linkedin.com/in/xaviergeerinck',
    ...
    },
    {
      ...
      url: 'https://github.com/xaviergeerinck', // Assuming standard handle based on name
      desc: 'Codebase & PRs'
    }
  ];
          ...
          <div className="p-4 bg-zinc-950 border border-zinc-800 flex flex-col gap-3 group hover:border-indigo-500/50 transition-colors">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                   <div className="text-xs font-mono text-zinc-500 uppercase tracking-wider">Direct Message</div>
                   <div className="text-white font-medium">contact@xaviergeerinck.com</div>
                </div>
              </div>
              <div className="flex gap-2">
                ...
                <a 
                  href="mailto:contact@xaviergeerinck.com"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            {socialLinks.map((link) => (
              ...
              >
                ...
                <div className="text-sm font-bold text-zinc-200 mb-1">{link.label}</div>
                <div className="text-[10px] text-zinc-500 font-mono uppercase">{link.desc}</div>
              </a>
            ))}
          </div>
        </div>
